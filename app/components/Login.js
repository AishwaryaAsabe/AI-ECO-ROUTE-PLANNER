...
export default function LoginForm({ onLogin = () => {} }) { 
  // Accept onLogin callback as a prop, with a default empty function
  const [email, setEmail] = useState('');
  const [password, setPassword] = useState('');
  const router = useRouter();

  // Inside your LoginForm.js
  const handleSubmit = async (e) => {
    e.preventDefault();
    ...
    // Call the onLogin callback to update the login state in RootLayout
    onLogin();  // This will set the logged-in state in the parent
